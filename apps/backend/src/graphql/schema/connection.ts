...
const typeDefs = gql`
  ...
  extend type Query {
    ...
    checkConnectionStatus(requesterUserId: String!, addresseeUserId: String!): String!
  }

  extend type Mutation {
    sendFriendReq(requesterUserId: String!, addresseeUserId: String!, message: String): Connection!
